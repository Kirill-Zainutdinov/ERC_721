...
describe("Testing ERC721",  function () {
    ...
    describe("Deployment", function () {
        ...
        it("Check that the token _symbol is set correctly", async function () {
            const { erc721, symbol } = await loadFixture(deploy)

            expect(await erc721.symbol()).to.equal(symbol)
        })

        it("Check that the token _tokenId is set correctly", async function () {
            const { erc721 } = await loadFixture(deploy)

            expect(await erc721.getTokenId()).to.equal(0)
        })

        it("Check that the token _baseURI is set correctly", async function () {
    ...
    describe("Mint", function () {
        ...
        describe("Mint", function () {
            ...
            it("Check that token emission correctly changes the _tokenId", async function () {
                const { erc721, account } = await loadFixture(deploy)
            ...
            it("Check that the owner of the token is set correctly", async function () {
                const { erc721, account } = await loadFixture(deploy)
            ...
            it("Check that the URI of the token is returned correctly", async function () {
    ...
    describe("setApprovalForAll", function () {
        describe("setApprovalForAll", function () {
            it("Check that the function setApprovalForAll correctly set true", async function () {
            ...
            it("Check that the function setApprovalForAll correctly set false", async function () {
                const { erc721, owner, account } = await loadFixture(deploy)
        ...
        describe("Event", function () {
            it("Check emit an event on setApprovalForAll", async function () {
                const { erc721, owner, account } = await loadFixture(deploy)
    ...
    describe("TransferFrom", function () {
        ...
        describe("Check that the function transferFrom", function () {
            it("Correctly change balance. Caller - token owner", async function () {
                const { erc721, owner, account } = await loadFixture(deploy)
            ...
            it("Correctly change token owner. Caller - token owner", async function () {
                const { erc721, owner, account } = await loadFixture(deploy)
            ...
            it("Correctly change balance. Caller - operator of token", async function () {
                const { erc721, owner, account, operator } = await loadFixture(deploy)
            ...
            it("Correctly change token owner. Caller - operator of token", async function () {
                const { erc721, owner, account, operator } = await loadFixture(deploy)
            ...
            it("Correctly change balance. Caller - operator of all tokens", async function () {
                const { erc721, owner, account, operator } = await loadFixture(deploy)
            ...
            it("Correctly change token owner. Caller - operator of all tokens", async function () {
                const { erc721, owner, account, operator } = await loadFixture(deploy)
    ...
    describe("safeTransferFrom(address, address, uint256)", function () {
        ...
        describe("Check that the function safeTransferFrom(address, address, uint256)", function () {
            it("Correctly change balance. Caller - token owner. Receiver - EOA", async function () {
                const { erc721, owner, account } = await loadFixture(deploy)
            ...
            it("Correctly change token owner. Caller - token owner. Receiver - EOA", async function () {
                const { erc721, owner, account } = await loadFixture(deploy)
            ...
            it("Correctly change balance. Caller - operator of token. Receiver - EOA", async function () {
                const { erc721, owner, account, operator } = await loadFixture(deploy)
            ...
            it("Correctly change token owner. Caller - operator of token. Receiver - EOA", async function () {
                const { erc721, owner, account, operator } = await loadFixture(deploy)
            ...
            it("Correctly change balance. Caller - operator of all tokens. Receiver - EOA", async function () {
                const { erc721, owner, account, operator } = await loadFixture(deploy)
            ...
            it("Correctly change token owner. Caller - operator of all tokens. Receiver - EOA", async function () {
                const { erc721, owner, account, operator } = await loadFixture(deploy)
            ...
            it("Correctly change balance. Caller - token owner. Receiver - Contract", async function () {
            ...
            it("Correctly change token owner. Caller - token owner. Receiver - Contract", async function () {
                const { erc721, owner, erc721Received } = await loadFixture(deploy)
            ...
            it("Correctly change balance. Caller - operator of token. Receiver - Contract", async function () {
            ...
            it("Correctly change token owner. Caller - operator of token. Receiver - Contract", async function () {
                const { erc721, owner, erc721Received, operator } = await loadFixture(deploy)
            ...
            it("Correctly change balance. Caller - operator of all tokens. Receiver - Contract", async function () {
                const { erc721, owner, erc721Received, operator } = await loadFixture(deploy)
            ...
            it("Correctly change token owner. Caller - operator of all tokens. Receiver - Contract", async function () {
                const { erc721, owner, erc721Received, operator } = await loadFixture(deploy)
    ...
    describe("safeTransferFrom(address, address, uint256, bytes)", function () {
        ...
        describe("Check that the function safeTransferFrom(address, address, uint256, bytes)", function () {
            it("Correctly change balance. Caller - token owner. Receiver - EOA", async function () {
                const { erc721, owner, account } = await loadFixture(deploy)
    ...
    describe("SupportsInterface", function () {
        it("Check that function works correctly with IERC721 interfaceId", async function () {
            const { erc721 } = await loadFixture(deploy)
        ...
        it("Check that function works correctly with IERC721Metadata interfaceId", async function () {
            const { erc721 } = await loadFixture(deploy)
        ...
        it("Check that function works correctly with IERC165 interfaceId", async function () {
            const { erc721 } = await loadFixture(deploy)
        ...
        it("Check that function works correctly with any another interfaceId", async function () {
            const { erc721 } = await loadFixture(deploy)
    ...
    describe("tokenURI", function () {
        describe("Require", function () {
            it("Check that you cannot get the uri of a token that does not exist", async function () {
                const { erc721 } = await loadFixture(deploy)
        ...
        describe("tokenURI", function () {
            it("Check the correctness of the function", async function () {
